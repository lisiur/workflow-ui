...
export class EzCanvas {
    ...
    constructor(canvas) {
        ...
        this.ctx = ctx;
        this.layers = new Map();
        this.layerCanvas = new Map();
        this.layerCanvasCtx = new Map();
        this.orderedLayers = [];
    ...
    addWidgetToLayer(layerName, widget) {
    ...
    syncLayerCanvas(layer) {
        const canvas = this.layerCanvas.get(layer);
        const ctx = this.layerCanvasCtx.get(layer);
        // 同步宽高
